...
public class Util extends Queue {
    ...
    public static String getPageNavigation(String command, int page, int totalPages) {
        ...
        if (totalPages > 1) {
            ...
            for (int displayPage = displayStart; displayPage <= displayEnd; displayPage++) {
                ...
                if (page != displayPage) {
                    ...
                    pagination.append(Color.WHITE + Color.UNDERLINE + displayPage + Color.RESET
        ...
        return message.append(Color.WHITE + backArrow + Color.DARK_AQUA
                + Phrase.build(Phrase.LOOKUP_PAGE, Color.WHITE + page + "/" + totalPages) + nextArrow + pagination)
                .toString();
    ...
    public static int setPlayerArmor(PlayerInventory inventory, ItemStack itemStack) {
        ...
        boolean isHelmet = (itemName.endsWith("_HELMET") || itemName.endsWith("_HEAD") || itemName.endsWith("_SKULL")
    ...
    public static boolean iceBreakCheck(BlockState block, String user, Material type) {
        ...
        if (type.equals(Material.ICE)) { // Ice block
            ...
            CacheHandler.lookupCache.put("" + block.getX() + "." + block.getY() + "." + block.getZ() + "." + wid + "",
                    new Object[]
                    { unixtimestamp, user, Material.WATER });
            return true;
    ...
    public static void prepareTypeAndData(Map<Block, BlockData> map, Block block, Material type, BlockData blockData,
            boolean update)
    {
