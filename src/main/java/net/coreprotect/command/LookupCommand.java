                ...
                public void run() {
                    ...
                    try (Connection connection = Database.getConnection(true)) {
                        ...
                        if (connection != null) {
                            ...
                            List<String> blockData = ChestTransactionLookup.performLookup(command.getName(), statement,
                ...
                if (type == 5) {
                    ...
                    if (rollbackusers.contains("#container")) {
                        ...
                        if (argAction.contains(6) || argAction.contains(7) || argAction.contains(8)
                                || argAction.contains(9) || argAction.contains(10) || argAction.contains(11))
                        {
                    ...
                    class BasicThread2 implements Runnable {
                        ...
                        public void run() {
                            ...
                            try (Connection connection = Database.getConnection(true)) {
                                ...
                                String bc = finalX + "." + finalY + "." + finalZ + "." + finalWid + "." + finalTimeStart
                                        + "." + finalTimeEnd + "." + noisy + "." + excluded + "." + restricted + "."
                                        + finalArgWid + "." + displayResults;
                                    ...
                                    if (exists) {
                                        ...
                                        if (checkRows) {
                                            ...
                                            rows = Lookup.countLookupRows(statement, player2, uuidList, userList, blist,
                                                    elist, euserlist, finalArgAction, location, radius, rowData,
                                                    finalTimeStart, finalTimeEnd, restrict_world, true);
                                            rowData[3] = rows;
                                        ...
                                        if (finalCount) {
                                            ...
                                            List<String[]> lookupList = Lookup.performPartialLookup(statement, player2,
                                                    ...
                                                    location, radius, rowData, finalTimeStart, finalTimeEnd,
                                                    (int) pageStart, displayResults, restrict_world, true);

                                            Chat.sendMessage(player2, Color.WHITE + "----- " + Color.DARK_AQUA
                                                    + Phrase.build(Phrase.LOOKUP_HEADER,
                                                            "CoreProtect" + Color.WHITE + " | " + Color.DARK_AQUA)
                                                    + Color.WHITE + " -----");
                                            if (finalArgAction.contains(6) || finalArgAction.contains(7)) { // Chat/command
                                                ...
                                                for (String[] data : lookupList) {
                                                    ...
                                                    Chat.sendComponent(
                                                            ...
                                                            message);
                                                    if (PluginChannelHandshakeListener.getInstance()
                                                            .isPluginChannelPlayer(player2))
                                                    {
                                                        ...
                                                        PluginChannelListener.getInstance().sendMessageData(player2,
                                                                Integer.parseInt(time), dplayer, message, false, x, y,
                                                                z, wid);
                                                ...
                                                for (String[] data : lookupList) {
                                                    ...
                                                    if (timeLength % 4 == 0) {
                                                        ...
                                                        leftPadding = leftPadding + Color.WHITE
                                                                + Strings.padStart("", (timeLength - 50) / 4, ' ');

                                                    }

                                                    String tag = (action != 0 ? Color.GREEN + "+" : Color.RED + "-");
                                                    Chat.sendComponent(player2, timeago + " " + tag + " "
                                                            + Color.DARK_AQUA
                                                    ...
                                                    Chat.sendComponent(player2,
                                                            Color.WHITE + leftPadding + Color.GREY + "^ "
                                                                    + Util.getCoordinates(command.getName(), wid, x, y,
                                                                            z, true, true)
                                                                    + "");
                                                    PluginChannelListener.getInstance().sendInfoData(player2,
                                                            Integer.parseInt(time), Phrase.LOOKUP_LOGIN,
                                                            (action != 0 ? Selector.FIRST : Selector.SECOND), dplayer,
                                                            -1, x, y, z, wid);
                                                ...
                                                for (String[] data : lookupList) {
                                                    ...
                                                    PluginChannelListener.getInstance().sendUsernameData(player2,
                                                            Integer.parseInt(time), user, username);
                                                ...
                                                for (String[] data : lookupList) {
                                                    ...
                                                    Chat.sendComponent(player2,
                                                            Color.WHITE + leftPadding + Color.GREY + "^ "
                                                                    ...
                                                                    + "");
                                                    PluginChannelListener.getInstance().sendMessageData(player2,
                                                            Integer.parseInt(time), dplayer, message, true, x, y, z,
                                                            wid);

                                                }

                                            } else if (finalArgAction.contains(4) && finalArgAction.contains(11)) { // inventory
                                                                                                                    // transactions
                                                ...
                                                for (String[] data : lookupList) {
                                                    ...
                                                    String rbd = ((Integer.parseInt(data[8]) == 2
                                                            || Integer.parseInt(data[8]) == 3) ? Color.STRIKETHROUGH
                                                                    : "");
                                                    String timeago = Util.getTimeSince(Integer.parseInt(time),
                                                            unixtimestamp, true);
                                                    Material blockType = Util.itemFilter(Util.getType(dtype),
                                                            (Integer.parseInt(data[13]) == 0));
                                                    String dname = Util.nameFilter(
                                                            blockType.name().toLowerCase(Locale.ROOT), ddata);
                                                    byte[] metadata = data[11] == null ? null
                                                            : data[11].getBytes(StandardCharsets.ISO_8859_1);
                                                            ...
                                                            || daction == ItemLogger.ITEM_CREATE)
                                                    {
                                                        ...
                                                        selector = (daction == ItemLogger.ITEM_CREATE ? Selector.FIRST
                                                                : Selector.SECOND);
                                                        tag = (daction == ItemLogger.ITEM_CREATE ? Color.GREEN + "+"
                                                                : Color.RED + "-");

                                                    } else if (daction == ItemLogger.ITEM_SELL
                                                            || daction == ItemLogger.ITEM_BUY)
                                                    { // LOOKUP_TRADE

                                                        selector = (daction == ItemLogger.ITEM_BUY ? Selector.FIRST
                                                                : Selector.SECOND);
                                                        tag = (daction == ItemLogger.ITEM_BUY ? Color.GREEN + "+"
                                                                : Color.RED + "-");
                                                    ...
                                                    Chat.sendComponent(player2, timeago + " " + tag + " "
                                                            + Phrase.build(Phrase.LOOKUP_CONTAINER,
                                                                    Color.DARK_AQUA + rbd + dplayer + Color.WHITE + rbd,
                                                                    "x" + amount,
                                                                    Util.createTooltip(Color.DARK_AQUA + rbd + dname,
                                                                            tooltip) + Color.WHITE,
                                                                    selector));
                                                    PluginChannelListener.getInstance().sendData(player2,
                                                            Integer.parseInt(time), Phrase.LOOKUP_CONTAINER, selector,
                                                            dplayer, dname, amount, x, y, z, wid, rbd, true,
                                                            tag.contains("+"));
                                                ...
                                                for (String[] data : lookupList) {
                                                            ...
                                                            || finalArgAction.contains(11) || amount > -1)
                                                    {
                                                        ...
                                                        if (daction == 2 || daction == 3) {
                                                            ...
                                                            selector = (daction != 7 ? Selector.FIRST
                                                                    : Selector.SECOND);
                                                            tag = Color.RED + "-";
                                                            action = "a:item";
                                                        ...
                                                        Chat.sendComponent(player2,
                                                                timeago + " " + tag + " " + Phrase.build(phrase,
                                                                        Color.DARK_AQUA
                                                                                + rbd + dplayer + Color.WHITE + rbd,
                                                                        "x" + amount,
                                                                        Util.createTooltip(
                                                                                Color.DARK_AQUA + rbd + dname, tooltip)
                                                                                + Color.WHITE,
                                                                        selector));
                                                        PluginChannelListener.getInstance().sendData(player2,
                                                                Integer.parseInt(time), phrase, selector, dplayer,
                                                                dname, (tag.contains("+") ? 1 : -1), x, y, z, wid, rbd,
                                                                action.contains("container"), tag.contains("+"));
                                            ...
                                            if (rows > displayResults) {
                                                ...
                                                if (finalArgAction.contains(6) || finalArgAction.contains(7)
                                                        || finalArgAction.contains(9)
                                                        || (finalArgAction.contains(4) && finalArgAction.contains(11)))
                                                {
