...
public class TabHandler implements TabCompleter {
    ...
    // "rollback", "restore", "lookup", "purge",
    // "reload", "status", "near", "undo" }; // max 10!
    ...
    private static String[] ACTIONS = new String[] { "block", "+block", "-block", "click", "kill", "+container",
            "-container", "container", "chat", "command", "+inventory", "-inventory", "inventory", "item", "+item",
            "-item", "sign", "session", "+session", "-session", "username" };
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 1) {
            ...
            for (int i = 1; i < args.length; i++) {
                ...
                if (arg.equals("#container")) {
                    ...
                    hasPreview = true;
                        ...
                        || arg.contains("u:") || arg.contains("user:") || arg.contains("users:") || arg.contains("p:"))
                {
            ...
            if ((lastArg.equals("a:") || lastArg.equals("action:")) && (sender.hasPermission("coreprotect.lookup")
                    || sender.hasPermission("coreprotect.rollback") || sender.hasPermission("coreprotect.restore")))
            {
                ...
                return StringUtil.copyPartialMatches(currentArg, completions, new ArrayList<>(completions.size()));
                    ...
                    && (sender.hasPermission("coreprotect.lookup") || sender.hasPermission("coreprotect.rollback")
                            ...
                            || sender.hasPermission("coreprotect.purge")))
            {
                ...
                return StringUtil.copyPartialMatches(filter + arg, completions, new ArrayList<>(completions.size()));
                    ...
                    && (sender.hasPermission("coreprotect.lookup") || sender.hasPermission("coreprotect.lookup.near")
            ...
            } else if ((sender.hasPermission("coreprotect.lookup") || sender.hasPermission("coreprotect.rollback")
                    || sender.hasPermission("coreprotect.restore"))
                    && (lastArg.equals("i:") || lastArg.equals("include:") || lastArg.equals("item:")
                            || lastArg.equals("items:") || lastArg.equals("b:") || lastArg.equals("block:")
                            || lastArg.equals("blocks:") || currentArg.startsWith("i:")
                            || currentArg.startsWith("include:") || currentArg.startsWith("item:")
                            || currentArg.startsWith("items:") || currentArg.startsWith("b:")
                            || currentArg.startsWith("block:") || currentArg.startsWith("blocks:")
                            || lastArg.equals("e:") || lastArg.equals("exclude:") || currentArg.startsWith("e:")
                            || currentArg.startsWith("exclude:")))
            {
                ...
                } else if ((sender.hasPermission("coreprotect.lookup")
                        && (argument0.equals("l") || argument0.equals("lookup")))
                        || (sender.hasPermission("coreprotect.rollback")
                                && (argument0.equals("rollback") || argument0.equals("rb") || argument0.equals("ro")))
                        || (sender.hasPermission("coreprotect.restore")
                                && (argument0.equals("restore") || argument0.equals("rs") || argument0.equals("re"))))
                {
