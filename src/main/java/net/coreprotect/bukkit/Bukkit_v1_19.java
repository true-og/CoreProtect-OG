...
public class Bukkit_v1_19 extends Bukkit_v1_18 implements BukkitInterface {
    ...
    public Bukkit_v1_19() {
        ...
        BlockGroup.TRACK_SIDE = new HashSet<>(Arrays.asList(
                Material.WALL_TORCH,
        ...
        BlockGroup.DOORS = new HashSet<>(Arrays.asList(
                Material.OAK_DOOR,
        ...
        BlockGroup.BUTTONS = new HashSet<>(Arrays.asList(
        ...
        BlockGroup.PRESSURE_PLATES = new HashSet<>(Arrays.asList(
        ...
        BlockGroup.SAFE_INTERACT_BLOCKS = new HashSet<>(Arrays.asList(
                Material.LEVER,
                Material.MANGROVE_TRAPDOOR,
                Material.ACACIA_TRAPDOOR,
                Material.BIRCH_TRAPDOOR,
