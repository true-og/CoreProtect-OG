...
public class Queue {
    ...
    private static synchronized void queueStandardData(int consumerId, int currentConsumer, String[] user,
            Object object)
    {
            ...
            Material breakType, int extraData, int blockNumber)
    {
        ...
        } else if (type == Material.IRON_DOOR || BlockGroup.DOORS.contains(type) || type.equals(Material.SUNFLOWER)
                || type.equals(Material.LILAC) || type.equals(Material.TALL_GRASS) || type.equals(Material.LARGE_FERN)
                || type.equals(Material.ROSE_BUSH) || type.equals(Material.PEONY))
        { // Double plant
            ...
            BlockState blockReplaced, Material forceType, int forceD, int forceData, String blockData)
    {
        ...
        if (blockReplaced != null) {
            ...
            if ((replaceType == Material.IRON_DOOR || BlockGroup.DOORS.contains(replaceType)
                    || replaceType.equals(Material.SUNFLOWER) || replaceType.equals(Material.LILAC)
        ...
        addConsumer(currentConsumer,
                new Object[]
                { consumerId, Process.BLOCK_PLACE, type, data, replaceType, replaceData, forceData, blockData,
                        replacedBlockData });
            ...
            Object inventory, int chestId)
    {
        ...
        addConsumer(currentConsumer,
                new Object[]
                { consumerId, Process.CONTAINER_TRANSACTION, type, 0, null, 0, chestId, null });
    ...
    protected static void queueEntityKill(String user, Location location, List<Object> data, EntityType type) {
        ...
        queueStandardData(consumerId, currentConsumer, new String[] { user, null },
                new Object[]
                { location.getBlock().getState(), type, null });
            ...
            String blockData, int data)
    {
        ...
        addConsumer(currentConsumer,
                new Object[]
                { consumerId, Process.NATURAL_BLOCK_BREAK, type, data, null, 0, 0, blockData });
    ...
    protected static void queuePlayerChat(Player player, String message, long timestamp) {
        ...
        queueStandardData(consumerId, currentConsumer, new String[] { player.getName(), null },
                new Object[]
                { timestamp, player.getLocation().clone() });
    ...
    protected static void queuePlayerInteraction(String user, BlockState block, Material type) {
        ...
        addConsumer(currentConsumer,
                new Object[]
                { consumerId, Process.PLAYER_INTERACTION, type, 0, null, 0, 0, null });
        queueStandardData(consumerId, currentConsumer, new String[] { user, null }, block);
    ...
    protected static void queuePlayerKill(String user, Location location, String player) {
        ...
        queueStandardData(consumerId, currentConsumer, new String[] { user, null },
                new Object[]
                { location.getBlock().getState(), player });
    ...
    protected static void queueRollbackUpdate(String user, Location location, List<Object[]> list, int table,
            int action)
    {
    ...
    protected static void queueSignText(String user, Location location, int action, int color, int colorSecondary,
            boolean frontGlowing, boolean backGlowing, boolean isWaxed, boolean isFront, String line1, String line2,
            String line3, String line4, String line5, String line6, String line7, String line8, int offset)
    {
        ...
        addConsumer(currentConsumer,
                new Object[]
                { consumerId, Process.SIGN_TEXT, null, color, null, action, offset, null });
        Consumer.consumerSigns.get(currentConsumer).put(consumerId,
                new Object[]
                { colorSecondary, Util.getSignData(frontGlowing, backGlowing), isWaxed, isFront, line1, line2, line3,
    ...
    protected static void queueSignUpdate(String user, BlockState block, int action, int time) {
        ...
        addConsumer(currentConsumer,
                new Object[]
                { consumerId, Process.SIGN_UPDATE, null, action, null, 0, time, null });
        queueStandardData(consumerId, currentConsumer, new String[] { user, null }, block);
