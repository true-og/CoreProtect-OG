...
public class Queue {
    ...
    protected static void queueBlockBreak(
        ...
        addConsumer(
                currentConsumer,
                new Object[] {consumerId, Process.BLOCK_BREAK, type, extraData, breakType, 0, blockNumber, blockData});
        queueStandardData(consumerId, currentConsumer, new String[] {user, null}, block);
    }
    ...
    protected static void queueBlockPlace(
        ...
        if (blockReplaced != null) {
            ...
            if ((replaceType == Material.IRON_DOOR
                ...
                BlockState blockBelow = blockReplaced
                        .getWorld()
    ...
    protected static void queueBlockGravityValidate(
            final String user, final Location location, final Block block, final Material blockType, int ticks) {
        Scheduler.scheduleSyncDelayedTask(
                CoreProtect.getInstance(),
                () -> {
                    try {
    ...
    protected static void queueItemTransaction(String user, Location location, int time, int offset, int itemId) {
        ...
        addConsumer(
                currentConsumer,
                new Object[] {consumerId, Process.ITEM_TRANSACTION, null, offset, null, time, itemId, null});
        queueStandardData(consumerId, currentConsumer, new String[] {user, null}, location);
    }
    ...
    protected static void queueEntityKill(String user, Location location, List<Object> data, EntityType type) {
        ...
        queueStandardData(consumerId, currentConsumer, new String[] {user, null}, new Object[] {
    ...
    protected static void queuePlayerChat(Player player, String message, long timestamp) {
        ...
        queueStandardData(consumerId, currentConsumer, new String[] {player.getName(), null}, new Object[] {
    ...
    protected static void queueSignText(
        ...
        */
        ...
        int consumerId = Consumer.newConsumerId(currentConsumer);
        addConsumer(
                currentConsumer, new Object[] {consumerId, Process.SIGN_TEXT, null, color, null, action, offset, null});
        Consumer.consumerSigns.get(currentConsumer).put(consumerId, new Object[] {
            colorSecondary,
            Util.getSignData(frontGlowing, backGlowing),
            isWaxed,
            isFront,
            line1,
            line2,
