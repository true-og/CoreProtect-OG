            ...
            if (inventories.get(id) != null) {
                ...
                if (ConfigHandler.loggingChest.get(loggingChestId) != null) {
                    ...
                    if (current_chest == forceData || force_size > 0) { // This prevents client side chest sorting mods
                        ...
                        if (force_size == 0 && ConfigHandler.oldContainer
                                .getOrDefault(loggingChestId, Collections.synchronizedList(new ArrayList<>()))
                                .size() == 1 && transactingChest != null && transactingChest.isEmpty())
                        {
                            ...
                            if (loopCount > maxInventorySize) {
                                ...
                                if (destinationContents != null) {
                                    ...
                                    ConfigHandler.hopperAbort.put(hopperPush,
                                            new Object[]
                                            { movedItems, destinationContents });
