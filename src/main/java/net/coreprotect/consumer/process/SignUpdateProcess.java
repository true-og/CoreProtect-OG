    ...
    static void process(Statement statement, Object object, String user, int action, int time) {
        ...
        if (object instanceof BlockState) {
            ...
            if (action == 0) {
                ...
                query = "SELECT color, color_secondary, data, waxed, face, line_1, line_2, line_3, line_4, line_5, line_6, line_7, line_8 FROM "
                        + ConfigHandler.prefix + "sign WHERE user='" + userid + "' AND wid='" + wid + "' AND x='" + x
                        + "' AND z='" + z + "' AND y='" + y + "' AND time < '" + time
