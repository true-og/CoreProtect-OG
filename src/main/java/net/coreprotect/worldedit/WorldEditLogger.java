...
public class WorldEditLogger extends Queue {
            ...
            com.sk89q.worldedit.world.block.BlockState oldBlock)
    {
        ...
        if (oldType == Material.SPAWNER || (Config.getConfig(location.getWorld()).SIGN_TEXT
                ...
                if (baseBlock != null && baseBlock.hasNbtData()) {
                            ...
                            && net.coreprotect.bukkit.BukkitAdapter.ADAPTER.isSign(oldType))
                    {
                        ...
                        if (!compoundTag.containsKey("front_text")) {
                            ...
                            int color = DyeColor.valueOf(baseBlock.getNbtData().getString("Color").toUpperCase())
                                    .getColor().asRGB();
                            ...
                            Queue.queueSignText(actor.getName(), location, 0, color, colorSecondary, frontGlowing,
                                    backGlowing, isWaxed, isFront, line1, line2, line3, line4, "", "", "", "", 5);
