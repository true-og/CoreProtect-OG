        ...
        Scheduler.runTask(CoreProtect.getInstance(), () -> {
            ...
            try {
                ...
                if (isInitialized()) {
                    ...
                    Chat.console(Phrase.build(Phrase.INTEGRATION_SUCCESS, isFAWE() ? "FastAsyncWorldEdit" : "WorldEdit",
                            Selector.FIRST));

                } else {

                    Chat.console(Phrase.build(Phrase.INTEGRATION_ERROR, isFAWE() ? "FastAsyncWorldEdit" : "WorldEdit",
                            Selector.FIRST));
