        ...
        try {
            ...
            if (type != Material.ENDER_CHEST) {
                ...
                ItemLogger.logTransaction(
                        preparedStmtItems, batchCount, 0, player, location, oldInventory, ItemLogger.ITEM_REMOVE_ENDER);
                ItemLogger.logTransaction(
                        preparedStmtItems, batchCount, 0, player, location, newInventory, ItemLogger.ITEM_ADD_ENDER);
            }
