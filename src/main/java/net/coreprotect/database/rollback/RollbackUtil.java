...
public class RollbackUtil extends Lookup {
    ...
    protected static int modifyContainerItems(Material type, Object container, int slot, ItemStack itemstack,
            int action)
    {
            ...
            if (type != null && type.equals(Material.ARMOR_STAND)) {
                ...
                if (inventory != null) {
                    ...
                    if (action == 1) {
                        ...
                        ItemStack[] inventoryContents = (isPlayerInventory ? inventory.getContents()
            ...
            for (List<Map<String, Object>> map : (List<List<Map<String, Object>>>) list) {
                ...
                if (mapData.get("slot") != null) {
                        ...
                        for (Map.Entry<Object, Map<String, Object>> entry : modifiersMap.entrySet()) {
                            ...
                            try {
                                ...
                                if (entry.getKey() instanceof Attribute) {
                                    ...
                                    attribute = (Attribute) BukkitAdapter.ADAPTER
                                            .getRegistryValue((String) entry.getKey(), Attribute.class);
                    ...
                    if ((rowType == Material.LEATHER_HORSE_ARMOR) || (rowType == Material.LEATHER_HELMET)
                            ...
                            || (rowType == Material.LEATHER_BOOTS))
                    { // leather armor
                        ...
                        if (itemCount == 1) {
                            ...
                            for (Map<String, Object> fireworkData : map) {
                                ...
                                org.bukkit.FireworkEffect.Type type = (org.bukkit.FireworkEffect.Type) fireworkData
                                        .getOrDefault("type", org.bukkit.FireworkEffect.Type.BALL);
