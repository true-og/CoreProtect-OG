    ...
    protected void onBlockIgnite(BlockIgniteEvent event) {
        ...
        if (!event.isCancelled() && Config.getConfig(world).BLOCK_IGNITE) {
            ...
            if (event.getPlayer() == null) {
                ...
                if (blockIgnited == Material.FIRE && event.getCause() == IgniteCause.LAVA
                ...
                if (event.getCause() == IgniteCause.FIREBALL) {
                    ...
                    ProjectileLaunchListener.playerLaunchProjectile(event.getPlayer().getLocation(),
                            event.getPlayer().getName(), new ItemStack(Material.FIRE_CHARGE), 1, -1, 1,
                ...
                CacheHandler.lookupCache.put(
                        "" + block.getX() + "." + block.getY() + "." + block.getZ() + "." + world_id + "", new Object[]
                        { unixtimestamp, player.getName(), block.getType() });
