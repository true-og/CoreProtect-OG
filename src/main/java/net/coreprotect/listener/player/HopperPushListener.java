...
public final class HopperPushListener {
    ...
    static void processHopperPush(Location location, String user, InventoryHolder sourceHolder,
            InventoryHolder destinationHolder, ItemStack item)
    {
        ...
        Scheduler.runTaskAsynchronously(CoreProtect.getInstance(), () -> {
            ...
            try {
                ...
                boolean abort = false;
                boolean addedInventory = Util.canAddContainer(destinationContainer, movedItem,
                ...
                if (abort) {
                    ...
                    ConfigHandler.hopperAbort.put(loggingChestId,
                            new Object[]
                            { movedItems, Util.getContainerState(destinationContents) });
                    return;
                ...
                InventoryChangeListener.onInventoryInteract(user, destinationInventory, originalDestination, null,
