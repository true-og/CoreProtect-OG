...
public final class PlayerCommandListener extends Queue implements Listener {
    ...
    public void onPlayerCommandPreprocess(PlayerCommandPreprocessEvent event) {
        ...
        /*
         * if (Config.getGlobal().ENTITY_KILLS &&
         * player.hasPermission("bukkit.command.kill")) {
     ...
     * onServerCommand(ServerCommandEvent event) { if
     * (Config.getGlobal().ENTITY_KILLS &&
     * event.getCommand().toLowerCase(Locale.ROOT).startsWith("kill")) {
