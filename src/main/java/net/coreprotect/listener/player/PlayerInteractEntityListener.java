...
public final class PlayerInteractEntityListener extends Queue implements Listener {
    ...
    protected void onPlayerInteractEntity(PlayerInteractEntityEvent event) {
        ...
        if (entity instanceof ItemFrame) {
            ...
            if (frame.getItem().getType() != Material.AIR && event.getHand().equals(EquipmentSlot.HAND)
                    && Config.getConfig(player.getWorld()).PLAYER_INTERACTIONS)
            {

                Queue.queuePlayerInteraction(player.getName(), entity.getLocation().getBlock().getState(),
                        Material.ITEM_FRAME);
            ...
            if (frame.getItem().getType().equals(Material.AIR) && !handItem.getType().equals(Material.AIR)) { // add
                                                                                                              // item to
                                                                                                              // item
                                                                                                              // frame
                ...
                queueContainerSpecifiedItems(player.getName(), Material.ITEM_FRAME,
                        new Object[]
            ...
            if (allayItem.getType().equals(Material.AIR)) {
                ...
                CraftItemListener.logCraftedItem(player.getLocation(), player.getName(), removedItem,
    ...
    public static void queueContainerSpecifiedItems(String user, Material type, Object container, Location location,
            boolean logDrop)
    {
