...
public final class HopperPullListener {
    ...
    static void processHopperPull(Location location, String user, InventoryHolder sourceHolder,
            InventoryHolder destinationHolder, ItemStack item)
    {
        ...
        Scheduler.runTaskAsynchronously(CoreProtect.getInstance(), () -> {
            ...
            try {
                ...
                InventoryChangeListener.onInventoryInteract(user, sourceInventory, originalSource, null,
