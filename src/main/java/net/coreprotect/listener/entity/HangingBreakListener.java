        ...
        if (entity instanceof ItemFrame || entity instanceof Painting) {
                    ...
                    || cause.equals(HangingBreakEvent.RemoveCause.OBSTRUCTION))
            {
                ...
                if (entity instanceof ItemFrame) {
                    ...
                    if (!event.isCancelled() && Config.getConfig(entity.getWorld()).ITEM_TRANSACTIONS) {
                        ...
                        if (itemframe.getItem().getType() != Material.AIR) {
                            ...
                            PlayerInteractEntityListener.queueContainerSpecifiedItems(causeName, Material.ITEM_FRAME,
                                    new Object[]
                                    { oldState, newState, itemframe.getFacing() }, itemframe.getLocation(), logDrops);
                ...
                if (!event.isCancelled() && Config.getConfig(blockEvent.getWorld()).NATURAL_BREAK) {
                    ...
                    Queue.queueNaturalBlockBreak(causeName, blockEvent.getState(), attachedBlock, material, blockData,
                            itemData);
